...
import (
	...
	"github.com/FusionFoundation/go-fusion/accounts/keystore"
	"github.com/FusionFoundation/go-fusion/common"
	"github.com/FusionFoundation/go-fusion/common/fdlimit"
	...
	"github.com/FusionFoundation/go-fusion/eth"
	"github.com/FusionFoundation/go-fusion/eth/downloader"
	"github.com/FusionFoundation/go-fusion/eth/gasprice"
	"github.com/FusionFoundation/go-fusion/ethdb"
	"github.com/FusionFoundation/go-fusion/ethstats"
	"github.com/FusionFoundation/go-fusion/graphql"
	"github.com/FusionFoundation/go-fusion/les"
	"github.com/FusionFoundation/go-fusion/log"
	"github.com/FusionFoundation/go-fusion/metrics"
	"github.com/FusionFoundation/go-fusion/metrics/influxdb"
	"github.com/FusionFoundation/go-fusion/miner"
	"github.com/FusionFoundation/go-fusion/node"
	"github.com/FusionFoundation/go-fusion/p2p"
	"github.com/FusionFoundation/go-fusion/p2p/discv5"
	"github.com/FusionFoundation/go-fusion/p2p/enode"
	"github.com/FusionFoundation/go-fusion/p2p/nat"
	...
	whisper "github.com/FusionFoundation/go-fusion/whisper/whisperv6"
...
func setBootstrapNodesV5(ctx *cli.Context, cfg *p2p.Config) {
	...
	case ctx.GlobalBool(TestnetFlag.Name):
		urls = []string{} //params.TestnetBootnodes
	case ctx.GlobalBool(DevnetFlag.Name):
		urls = params.DevnetBootnodes
	case ctx.GlobalBool(RinkebyFlag.Name):
		urls = params.RinkebyBootnodes
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *eth.Config) {
	...
	CheckExclusive(ctx, DeveloperFlag, TestnetFlag, RinkebyFlag, GoerliFlag, DevnetFlag)
	...
	default:
		if cfg.NetworkId == params.MainnetChainConfig.ChainID.Uint64() {
